...
!!! info
    ...
    **Source Code Repository:** [https://github.com/redhat-appstudio-mjf/ls3-jan292026](https://github.com/redhat-appstudio-mjf/ls3-jan292026)

    **GitOps Repository:** [https://github.com/redhat-appstudio-mjf/ls3-jan292026-gitops](https://github.com/redhat-appstudio-mjf/ls3-jan292026-gitops)
...
To access the ls3-jan292026 application that was deployed using the Software Template, complete the following instructions:
...
| `MCP_TOOL_MODEL` | Model for tool calls: `openai/gpt-4o-mini` | Software Template Form |
...
If you are interested in seeing the deployed OpenShift/Kubernetes resources, all resources were deployed into your chosen project/namespace of hello. You can access this project/namespace through the web console (if available) or via your CLI.
